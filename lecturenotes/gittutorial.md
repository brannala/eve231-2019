...
git pull
```
If you have made changes to files in the directory use stash to store your changes before pulling. Alternatively, you could use just delete the previously cloned directory and clone a new copy.
